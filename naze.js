...
⭔ Url : ${anu.url}`,
		...
		let { pinterest } = require('./lib/scraper')
			...
			naze.sendMessage(m.chat, { image: buffer, caption: `*CABUL KONTTT*`, footer: nyoutube}, {quoted: m })
			}
			break
			case 'chitoge':
			case 'emilia':
			...
			case 'inori':
			{
				...
				naze.sendFileUrl(m.chat, { image: pler, caption: `*RANDOM ANIME DEK*`, footer: nyoutube}, { quoted: m})
			}
			break
			case 'couple': {
                m.reply(mess.wait)
...
case 'lava': case 'rock': case 'bloodglas': case 'hallowen': case 'darkgold': case 'joker': case 'wicker':
 case 'firework': case 'skeleton': case 'blackpink': case 'sand': case 'glue': case '1917': case 'leaves': {
			...
			naze.sendImage(m.chat, { image: { url: anu }, caption: `NIH AOVPLERRRR`}, { quoted: m })
			}
			break
			case 'galaxywp':
			...
			naze.sendImage(m.chat, { image: { url: anu }, caption: `NIH`}, { quoted: m })
			}
			break
//Pembatas Primbon========================================
