...
case 'lava': case 'rock': case 'bloodglas': case 'hallowen': case 'darkgold': case 'joker': case 'wicker':
 case 'firework': case 'skeleton': case 'blackpink': case 'sand': case 'glue': case '1917': case 'leaves': {
			...
			teks1 = q.split("|") [0]
			teks2 = q.split("|") [1]
			anu = await fetchJson(`https://alphabot-api.herokuapp.com/api/ephoto360/wallpaperaov?heroes=${text1}&text=${text2}&apikey=xElukpMH`)
			naze.sendMessage(m.chat, anu, `NIH AOVPLERRRR`, m)
			}
			break
//Pembatas Primbon========================================
